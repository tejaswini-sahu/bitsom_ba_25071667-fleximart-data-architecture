-- ==============================================
-- Part 1.3 – Business SQL Queries for FlexiMart
-- ==============================================
...
-- Business Question: Generate a detailed report showing 
-- each customer's name, email, total number of orders placed, 
-- and total amount spent. Include only customers who have placed 
-- at least 2 orders and spent more than ₹5,000. Order by total 
...
-- For each month, display the month name, 
-- total number of orders, total revenue, and 
